...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\textwidth]{Chapter1/davs_score_analysis.png} % Adjust the width as needed
    \caption{DAVS Score Analysis (Representative Logs/Curve)}
    \label{f1} % Optional: for referencing the figure in your document
\end{figure}

\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\textwidth]{Chapter1/training_curves.png} % Adjust the width as needed
    \caption{Training Curves (Representative Output)}
    \label{f1} % Optional: for referencing the figure in your document
\end{figure}

\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\textwidth]{Chapter1/accuracy_under_attack.png} % Adjust the width as needed
    \caption{Accuracy Under Attack (Representative Output)}
    \label{f1} % Optional: for referencing the figure in your document
\end{figure}
